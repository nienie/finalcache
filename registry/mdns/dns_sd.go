...
//
// DNSSDService implements the Zone interface and wraps an Service instance.
...
//
// This function returns the DNS response of the underlying Service
...
// ("Service Type Enumeration"), to allow browsing of the underlying Service
// instance.
