...
// NewMDNSService returns a new instance of Service.
//
...
func NewMDNSService(instance, service, domain, hostName string, port int, ips []net.IP, txt []string) (*Service, error) {
	// Sanity check inputs
	if instance == "" {
