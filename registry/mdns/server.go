...
// Server mDNS server is used to listen for mDNS queries and respond if we
...
//SendMulticast multicastResponse us used to send a multicast response packet
